        ...
        <main>
            <div className="cart-wishlist-top-part">
                ...
                <h6 data-aos="zoom-in" data-aos-duration="2000">
                    <Link to='/'><StaticLanguage en="Home" az="Ana Səhifə" /></Link> &gt; <span><StaticLanguage en="Wishlist" az="Bəyənİlənlər" /></span>
                </h6>
            </div>
            {isWishlistEmpty ?
                ...
                <div className="wishlist-section container-fluid">
                    <StaticLanguage
                        en={
                                        ...
                                        <tr key={index}>
                                            ...
                                            <td>
                                                <button className="add-to-cart-btn" onClick={() => {
                                                    ...
                                                    <StaticLanguage en="Add to Cart" az="Səbətə əlavə et" /> <HiOutlineArrowLongRight size={20} />
                                                </button>
                                            </td>
                                            <td>
                    ...
                    }}><StaticLanguage en="Clear Wishlist" az="Bəyənİlənlərİ təmİzlə" /></button>
                </div>}
