    ...
    return (
        <section className='choose-us-section'>
            ...
            <div className="choose-us-info">
                ...
                <p>We are the perfect place to come for a special occasion dinner or a casual meal with friends.</p>
                <p>Whether you're hosting a corporate event, cocktail party, luncheon, dinner, meeting, shower, wedding reception, bat/bar mitzvah or rehearsal dinner, we know we can offer you and your guests a truly memorable event. We have a variety of private event spaces that can accommodate up to 180 guests.</p>
                <ul>
